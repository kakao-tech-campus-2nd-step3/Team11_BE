...
#### 기능 설명
- 계약 종류와 보험 가입여부에 따른 전세사기 유형 검사를 실시합니다
- 전세사기 유형별 맞춤형 환급 과정 정보를 제공합니다
...
#### 기능 설명
- Socket 기반의 실시간 채팅 기반 전문가 상담을 제공합니다
- 상담 종료 예정 시각과 채팅방 닫힘 시각에 여유를 두어 유연한 상담이 가능합니다
...
- 지식인 홍보 BM 및 사이트 내 상담기능을 위해 전화번호를 필터링하여 홍보를 제한했습니다.
