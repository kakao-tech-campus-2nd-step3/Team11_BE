...
public class ConsultationController {
    ...
    public ResponseEntity<ConsultationResponseDto> requestConsultation(
        ...
        ConsultationResponseDto consultationResponseDto = consultationService.requestConsultation(
            principalDetails, consultationRequestDto);
    ...
    public ResponseEntity<ConsultationResponseDto> requestConsultation(
        ...
        ConsultationResponseDto consultationResponseDto = consultationService.completeConsultation(
            principalDetails, consultationId);
