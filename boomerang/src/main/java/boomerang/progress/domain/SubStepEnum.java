...
public enum SubStepEnum {
    A1_1("전세권-설정-알아보기"),
    A2BC3_2("전세사기-피해자-결정-알아보기"),
    A2BC3_3("전세사기-피해자-신청-조건-해당-알아보기"),
    A2BC3_4("온라인-오프라인-신청하기"),
    A2BC3_5("결정-신청서"),
    A2BC3_6("임대차-계약서-사본"),
    A2BC3_7("주민등록-초본"),
    A2BC3_8("개인-정보-수집-및-이용-동의서"),
    A2BC3_9("임대인의-파산선고-결정문-또는-회생개시-결정문-사본"),
    A2BC3_10("경매-공매개시-관련-서류-사본-1부"),
    A2BC3_11("집행권원"),
    A2BC3_12("임차권등기-서류"),
    A3_1("경매에-대해서-알아보기"),
    A3_2("경매-신청하기"),
