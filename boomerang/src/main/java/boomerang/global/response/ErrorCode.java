...
public enum ErrorCode {
    ...
    MENTOR_NOT_REGISTERED(HttpStatus.CONFLICT, "MT_004", "멘토로 등록되지 않은 사용자입니다."),
    ...
    CONSULTATION_MEMBER_IS_NOT_PARTICIPANT(HttpStatus.BAD_REQUEST,"CS012","상담에 속한 멤버가 아닙니다"),
